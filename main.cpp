...
{  
	...
	default:
	    ...
	    cout << "Usage: glitch [arguments] <filename>\n"
		 ...
		 << "\n\tNotes: Alpha channels are preserved, they are also generated,"
		 << "\n\tso if there is an image which has no alpha channel then"
		 << "\n\tone will be added. All effects respect alpha channels and"
		 << "\n\twill transform them like all other channels. There is no way"
